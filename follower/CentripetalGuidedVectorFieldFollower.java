...
public class CentripetalGuidedVectorFieldFollower implements Follower {
    ...
    public CentripetalGuidedVectorFieldFollower(double tangentDistance) {
    ...
    public CentripetalGuidedVectorFieldFollower(double tangentDistance, PIDCoefficients xPIDCoeffs, PIDCoefficients yPIDCoeffs, PIDCoefficients headingPIDCoeffs, double maxSpeed) {
        if (tangentDistance <= 0)
            this.tangentDistance = 0.1;
        else
            this.tangentDistance = tangentDistance;
    ...
    public CentripetalGuidedVectorFieldFollower(Params params) {
